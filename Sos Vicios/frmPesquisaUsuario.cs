...
namespace Sos_Vicios
{
    public partial class frmPesquisaUsuario : Form
    {
        ...
        public void pesquisaPorNome()
        {
            ...
            comm.CommandText = "select * from tbUsuarios where nome like '%" + txtDescricao.Text + "%'";
        ...
        {
            MySqlCommand comm = new MySqlCommand();
            comm.CommandText = "select * from tbUsuarios where idUsu = '" + txtDescricao.Text + "';";
            comm.CommandType = CommandType.Text;
            comm.Connection = Conexao.conectar();
        ...
        private void lstInformacoes_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            ...
            frmUsuario enviar = new frmUsuario(valor);
            enviar.Show();
            this.Hide();
        }
